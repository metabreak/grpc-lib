...
export class NumberMessageField implements MessageField {
  ...
  printDeserializeBinaryFromReader(printer: Printer): void {
    if (this.isPacked) {
      ...
      printer.add(
        `case ${this.messageField.number}: _instance.${this.attributeName} = _reader.read${this.protoDataType}();`,
      );
    }
  ...
  printSerializeBinaryToWriter(printer: Printer): void {
    if (this.isPacked) {
      ...
      printer.add(`if (_instance.${this.attributeName} || _instance.${
        ...
        _writer.write${this.protoDataType}(${
  ...
  printToProtobufJSONMapping(printer: Printer): void {
    if (this.isArray) {
      ...
      printer.add(
        `${this.attributeName}: this.${this.attributeName}${
